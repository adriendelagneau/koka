...
const ProductOriginal = () => {
  ...
  return (
    <div
      className="product-original relative z-20 top-0 left-0 flex min-h-screen w-full flex-col items-center overflow-hidden xl:items-start xl:pl-6"
      ref={screenRef}
    >
      ...
      <div className="font-poppins ml-3 flex flex-col gap-12 text-3xl uppercase sm:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
        ...
        <p className="flex gap-1 overflow-hidden">
          ...
          <span ref={ref4} className="text-secondary overflow-hidden">
            secret ?
          </span>
        </p>
